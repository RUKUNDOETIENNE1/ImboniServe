/**
 * DIE Analytics API — Supplier Intelligence
...
export default async function handler(req: NextApiRequest, res: NextApiResponse) {
  ...
  try {
    ...
    console.error('[DIE-Analytics] Supplier intelligence error:', error)
    return res.status(500).json({ error: 'Failed to generate supplier intelligence report' })
  }
}
