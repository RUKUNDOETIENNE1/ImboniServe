/**
 * DIE Analytics API — Operational Intelligence
...
export default async function handler(req: NextApiRequest, res: NextApiResponse) {
  ...
  try {
    ...
    console.error('[DIE-Analytics] Operational intelligence error:', error)
    return res.status(500).json({ error: 'Failed to generate operational intelligence report' })
  }
}
