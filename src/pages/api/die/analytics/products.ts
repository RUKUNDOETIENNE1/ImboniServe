/**
 * DIE Analytics API — Product Intelligence
...
export default async function handler(req: NextApiRequest, res: NextApiResponse) {
  ...
  try {
    ...
    console.error('[DIE-Analytics] Product intelligence error:', error)
    return res.status(500).json({ error: 'Failed to generate product intelligence report' })
  }
}
