                ...
                {Object.entries(groupedOrders).map(([supplierId, group]) => (
                  <div key={supplierId} className="border border-gray-200 rounded-lg p-4">
                      ...
                      {group.items.map((item) => (
                        <div key={item.productId} className="flex justify-between text-sm">
                          ...
                          <span className="font-semibold text-gray-900">
                            <CurrencyDisplay amount={item.unitPriceCents * item.quantity} inCents />
                          </span>
                        </div>
                      ))}
                    </div>
                    <div className="mt-2 pt-2 border-t border-gray-200 flex justify-between font-semibold">
                      <span>Subtotal</span>
                      <span><CurrencyDisplay amount={group.subtotal} inCents /></span>
                    </div>
                  </div>
                ))}
              </div>
            ...
            <div className="bg-white rounded-xl shadow-lg p-6 sticky top-4">
              ...
              <div className="space-y-3 mb-6">
                <div className="flex justify-between text-gray-600">
                  <span>Subtotal</span>
                  <span><CurrencyDisplay amount={totalCents} inCents /></span>
                </div>
                <div className="flex justify-between text-gray-600">
