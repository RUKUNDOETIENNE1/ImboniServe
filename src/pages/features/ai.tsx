...
export default function AIFeaturesPage() {
  ...
  return (
    <PublicLayout title="AI Features — Imboni Serve">
      <Head>
      ...
      <div key={locale} className="bg-imboni-light min-h-screen">
        <div className="max-w-5xl mx-auto px-4 py-16">
          ...
          <div className="text-center mb-14">
            ...
            <h1 className="text-4xl font-bold text-imboni-blue mb-4">AI That Works While You Work</h1>
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">AI isn't a feature. It's the foundation. Every AI capability does real work — not just displays data.</p>
          </div>
          ...
          <h2 className="text-xl font-bold text-gray-900 mb-6">AI-Powered Analytics</h2>
