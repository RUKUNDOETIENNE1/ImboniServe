...
export default function GrowthFeaturesPage() {
  ...
  return (
    <PublicLayout title="Growth Features — Imboni Serve">
      <Head>
      ...
      <div key={locale} className="bg-imboni-light min-h-screen">
        <div className="max-w-5xl mx-auto px-4 py-16">
          ...
          <div className="text-center mb-14">
            ...
            <h1 className="text-4xl font-bold text-imboni-blue mb-4">Switch Once. Grow Forever.</h1>
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">Operations are just the beginning. ImboniServe helps you find and keep customers.</p>
          </div>
          ...
          <div className="bg-white rounded-2xl p-8 shadow-lg border border-slate-100 mb-12">
            <div className="flex items-start gap-6">
              ...
              <div>
                ...
                <Link href="/discover" className="text-imboni-blue font-medium text-sm hover:text-imboni-orange mt-3 inline-flex items-center gap-1">
