...
export const PRICING_PLANS: PlanConfig[] = [
  ...
  },
  {
    ...
    description: 'For established restaurants and cafés growing operations',
    popular: true,
    features: [
  ...
  },
  {
    ...
    description: 'For hotels, chains, and high-volume restaurants scaling operations',
    popular: false,
    badge: '🏢 Multi-Branch',
    features: [
  ...
  },
  {
    ...
    description: 'Advanced businesses requiring optimization, automation, and intelligence',
    popular: false,
    badge: '👑 Premium',
    features: [
  ...
  },
  {
    ...
    annualTotalRWF: null,
    description: 'Strategic partnership for large organizations with specialized requirements',
    features: [
