-- Safe Migration: Add businessId columns and preserve existing data
-- This migration adds businessId columns as aliases to restaurantId columns
-- The Restaurant table name is preserved via Prisma's @@map directive
...
-- Step 5: Add foreign key constraints for businessId columns
...
-- Migration complete!
-- Note: The Restaurant table name is preserved in the database
-- Prisma will use "Business" model name in code via @@map("Restaurant")
