-- Recreate CostAnomalyAlert table (was dropped in 20260324 restaurant→business migration)
-- This table is managed outside Prisma (raw SQL) and used by CostAnomalyService
