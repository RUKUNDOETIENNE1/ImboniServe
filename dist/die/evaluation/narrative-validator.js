...
exports.computeNarrativeAccuracy = computeNarrativeAccuracy;
/**
 ...
 */
function computeNarrativeAccuracy(evaluated) {
    const cats = ['Finance', 'Operations', 'Supply Chain', 'Customer'];
    const map = new Map();
    for (const c of cats)
        map.set(c, { evaluated: 0, correct: 0 });
