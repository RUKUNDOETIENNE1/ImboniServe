...
exports.CostAnomalyService = void 0;
const prisma_1 = require("../../lib/prisma");
class CostAnomalyService {
    static isEnabled() {
        return process.env.AI_CPA_ENABLED !== 'false';
    }
    static async evaluateAndMaybeAlert(input) {
        if (!this.isEnabled())
            return null;
        try {
    ...
    static async listAlerts(businessId, status, limit = 100) {
        try {
    ...
    static async updateAlertStatus(id, businessId, status, notes) {
        try {
...
exports.CostAnomalyService = CostAnomalyService;
