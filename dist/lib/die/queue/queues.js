...
exports.intelligenceDLQ = exports.intelligenceQueue = exports.extractDLQ = exports.extractQueue = void 0;
...
exports.markIntelJobActive = markIntelJobActive;
exports.markIntelJobCompleted = markIntelJobCompleted;
exports.markIntelJobFailed = markIntelJobFailed;
exports.getIntelligenceQueueMetrics = getIntelligenceQueueMetrics;
exports.getFailedJobs = getFailedJobs;
exports.getFailedIntelligenceJobs = getFailedIntelligenceJobs;
...
exports.intelligenceQueue = new bullmq_1.Queue('die_intelligence', {
    connection,
    defaultJobOptions: {
        attempts: 3,
...
exports.intelligenceDLQ = new bullmq_1.Queue('die_intelligence_dlq', { connection });
// ---------------------------------------------------------------------------
...
async function getFailedIntelligenceJobs(limit = 50) {
    const jobs = await exports.intelligenceDLQ.getJobs(['wait', 'delayed', 'paused', 'waiting', 'active'], 0, Math.max(0, limit - 1));
    return jobs.map((job) => ({
        id: job.id,
        data: job.data,
        failedReason: job.failedReason || job.data?.error || 'unknown',
